    ...
    tr.innerHTML = `
      ...
      <td>
        <input class="form-control form-control-sm"
               ...
               title="Average number of interactions needed to complete scheduling through ${method}."
               value="${mean}">
      </td>
    `;
    ...
    tr.innerHTML = `
      ...
      <td>
        <input class="form-control form-control-sm"
               ...
               data-alloc-cat="${cat}"
               data-bs-toggle="tooltip"
               title="Number of provider minutes reserved when visit type ${cat} is scheduled."
               value="${minutes}">
      </td>
    `;
    tbody.appendChild(tr);
                  ...
                  <tr>
                    <th>
                      ...
                      <span class="info-icon" data-bs-toggle="tooltip"
                        title="Specific scheduling channel available to this population.">ⓘ</span>
                    </th>
                    <th>
                      Probability of Use
                      <span class="info-icon" data-bs-toggle="tooltip"
                ...
                <thead>
                  <tr>
                    <th>
                      Visit Type
                      <span class="info-icon" data-bs-toggle="tooltip"
                        title="Type of appointment this patient population may require.">ⓘ</span>
                    </th>
                    <th>
    ...
    methods.forEach((m, mi) => {
      ...
      tr.innerHTML = `
        ...
        <td><input class="form-control form-control-sm" type="number" step="0.001" min="0"
                   ...
                   data-bs-toggle="tooltip" title="Relative share of patients in ${pop} who use ${m.method}."
        ...
        <td><input class="form-control form-control-sm" type="number" step="0.001" min="0" max="1"
                   ...
                   data-bs-toggle="tooltip" title="Probability that a scheduling attempt through ${m.method} results in a booked appointment for ${pop}."
                   value="${m.p_schedule}"></td>
        <td><input class="form-control form-control-sm" type="number" step="0.001" min="0" max="1"
                   data-pop="${pop}" data-kind="method" data-idx="${mi}" data-field="p_complete"
                   data-bs-toggle="tooltip" title="Probability that a booked appointment through ${m.method} is ultimately completed for ${pop}."
        ...
        <td><input class="form-control form-control-sm" type="number" step="0.001"
                   ...
                   data-bs-toggle="tooltip" title="Average time-to-schedule parameter for ${m.method} in ${pop}."
                   value="${m.mu}"></td>
        <td><input class="form-control form-control-sm" type="number" step="0.001" min="0"
                   data-pop="${pop}" data-kind="method" data-idx="${mi}" data-field="sigma"
                   data-bs-toggle="tooltip" title="Variability in time-to-schedule for ${m.method} in ${pop}."
                   value="${m.sigma}"></td>
        <td><input class="form-control form-control-sm" type="number" step="0.001"
                   data-pop="${pop}" data-kind="method" data-idx="${mi}" data-field="mu2"
                   data-bs-toggle="tooltip" title="Average time from scheduling to completed appointment for ${m.method} in ${pop}."
                   value="${m.mu2}"></td>
        <td><input class="form-control form-control-sm" type="number" step="0.001" min="0"
                   data-pop="${pop}" data-kind="method" data-idx="${mi}" data-field="sigma2"
                   data-bs-toggle="tooltip" title="Variability in time from scheduling to completion for ${m.method} in ${pop}."
                   value="${m.sigma2}"></td>
      `;
      ...
      tr.innerHTML = `
        ...
        <td>
          <input class="form-control form-control-sm" type="number" step="0.001" min="0"
                 ...
                 data-bs-toggle="tooltip" title="Probability that a ${pop} patient needs visit type ${v.category}."
                 value="${v.prob}">
        </td>
      `;
